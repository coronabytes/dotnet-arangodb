...
namespace Core.Arango.Protocol
{
    ...
    {
        /// <summary>
        ///   The segment candidates for the “consolidation” operation are selected based upon several possible configurable formulas as defined by their types.
        /// </summary>
    ...
    public class ArangoView
    {
        ...
        ///   If a query iterates over all documents of a View, wants to sort them by attribute values and the (left-most) fields to sort by as well as their sorting direction match with the primarySort definition, then the SORT operation is optimized away.
        ...
        /// <summary>
        ///   Defines how to compress the primary sort data (introduced in v3.7.1). ArangoDB v3.5 and v3.6 always compress the index using LZ4.
        ///   This option is immutable.
        /// </summary>
        ...
        /// <summary>
        ///   Wait at least this many commits between removing unused files in the ArangoSearch data directory (default: 2, to disable use: 0).
        /// </summary>
        ...
        /// <summary>
        ///   Wait at least this many milliseconds between committing View data store changes and making documents visible to queries (default: 1000, to disable use: 0)
        /// </summary>
        ...
        /// <summary>
        ///   Wait at least this many milliseconds between applying ‘consolidationPolicy’ to consolidate View data store and possibly release space on the filesystem (default: 10000, to disable use: 0).
        /// </summary>
        ...
        ///   0 value should be used carefully due to high potential memory consumption (default: 33554432, use 0 to disable, immutable)
        /// </summary>
