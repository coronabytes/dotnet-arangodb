...
namespace Core.Arango.Protocol
{
    ...
    public class ArangoKeyOptions
    {
        ...
        ///   If set to false, then the key generator will solely be responsible for generating keys and supplying own key values in the _key attribute of documents is considered an error.
        /// </summary>
