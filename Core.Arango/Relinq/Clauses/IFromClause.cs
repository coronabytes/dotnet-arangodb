...
{
    /// <summary>
    ///     Common interface for from clauses (<see cref="AdditionalFromClause" /> and <see cref="MainFromClause" />). From
    ...
    ///     clauses.
    /// </summary>
    internal interface IFromClause : IClause, IQuerySource
    {
        /// <summary>
        ...
        /// <summary>
        ///     Copies the <paramref name="source" />'s attributes, i.e. the <see cref="IQuerySource.ItemName" />,
        ///     <see cref="IQuerySource.ItemType" />, and
