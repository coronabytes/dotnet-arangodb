...
namespace Core.Arango.Relinq.Clauses
{
    ...
    ///     This can either
    ///     be part of <see cref="QueryModel.BodyClauses" /> or of <see cref="GroupJoinClause" />. The semantics of the
    ///     <see cref="JoinClause" />
    ///     is that of an inner join, i.e. only combinations where both an input item and a joined item exist are returned.
    /// </summary>
    /// <example>
    ///     In C#, the "join" clause in the following sample corresponds to a <see cref="JoinClause" />. The
    ///     <see cref="JoinClause" /> adds a new
    ...
    ///     <see cref="ItemName" /> and
    ///     <see cref="ItemType" />, "Addresses" is <see cref="InnerSequence" /> and the left and right side of the "equals"
    ...
    /// </code>
    /// </example>
    internal sealed class JoinClause : IBodyClause, IQuerySource
    {
        ...
        ///     inner items are joined.
        /// </param>
        public JoinClause(string itemName, Type itemType, Expression innerSequence, Expression outerKeySelector,
    ...
    [DebuggerDisplay ("{Remotion.Linq.Clauses.ExpressionVisitors.FormattingExpressionVisitor.Format (InnerKeySelector),nq}")]
        ...
        ///     <see
        ///         cref="IQueryModelVisitor.VisitJoinClause(Core.Arango.Relinq.Clauses.JoinClause,Core.Arango.Relinq.QueryModel,int)" />
        ///     method.
        /// </summary>
        ...
        ///     Accepts the specified visitor by calling its
        ///     <see
        ///         cref="IQueryModelVisitor.VisitJoinClause(Core.Arango.Relinq.Clauses.JoinClause,Core.Arango.Relinq.QueryModel,Core.Arango.Relinq.Clauses.GroupJoinClause)" />
        ///     method. This overload is used when visiting a <see cref="JoinClause" /> that is held by a
        ///     <see cref="GroupJoinClause" />.
        /// </summary>
        /// <param name="visitor">The visitor to accept.</param>
        /// <param name="queryModel">The query model in whose context this clause is visited.</param>
