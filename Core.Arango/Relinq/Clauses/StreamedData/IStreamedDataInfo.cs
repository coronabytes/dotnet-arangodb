...
namespace Core.Arango.Relinq.Clauses.StreamedData
{
    ...
    /// </summary>
    internal interface IStreamedDataInfo : IEquatable<IStreamedDataInfo>
    {
        /// <summary>
        ///     Gets the type of the data described by this <see cref="IStreamedDataInfo" /> instance. For a sequence, this is a
        ///     type implementing
        ///     <see cref="IEnumerable{T}" />, where <c>T</c> is instantiated with a concrete type. For a single value, this is the
        ///     value type.
        /// </summary>
        Type DataType { get; }
        ...
        ///     <see cref="IQueryExecutor.ExecuteScalar{T}" /> or <see cref="IQueryExecutor.ExecuteCollection{T}" />, depending on
        ...
        /// <summary>
        ///     Returns a new <see cref="IStreamedDataInfo" /> of the same type as this instance, but with a new
        ///     <see cref="DataType" />.
        /// </summary>
        /// <param name="dataType">
        ///     The type to use for the <see cref="DataType" /> property. The type must be compatible with the data described by
        ///     this
        ///     <see cref="IStreamedDataInfo" />, otherwise an exception is thrown.
        ///     The type may be a generic type definition if the <see cref="IStreamedDataInfo" /> supports generic types; in this
        ///     case,
        ///     the type definition is automatically closed with generic parameters to match the data described by this
        ///     <see cref="IStreamedDataInfo" />.
        /// </param>
        /// <returns>
        ///     A new <see cref="IStreamedDataInfo" /> of the same type as this instance, but with a new
        ///     <see cref="DataType" />.
        /// </returns>
