...
namespace Core.Arango.Relinq.Clauses.StreamedData
{
    ...
    internal sealed class StreamedSequence : IStreamedData
    {
        ...
        [NotNull] public StreamedSequenceInfo DataInfo { get; }

        /// <summary>
        ///     Gets the current sequence for the <see cref="ResultOperatorBase.ExecuteInMemory(IStreamedData)" /> operation. If
        ...
        object IStreamedData.Value => Sequence;
