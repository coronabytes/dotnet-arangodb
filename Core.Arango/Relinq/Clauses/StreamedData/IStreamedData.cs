...
namespace Core.Arango.Relinq.Clauses.StreamedData
{
    ...
    ///     <see cref="ResultOperatorBase.ExecuteInMemory" />. The data held by implementations of this interface can be either
    ///     a value or a sequence.
    /// </summary>
    internal interface IStreamedData
    {
        /// <summary>
        ///     Gets an object describing the data held by this <see cref="IStreamedData" /> instance.
        /// </summary>
        /// <value>
        ///     An <see cref="IStreamedDataInfo" /> object describing the data held by this <see cref="IStreamedData" />
        ///     instance.
        /// </value>
