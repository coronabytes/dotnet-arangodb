...
{
    /// <summary>
    ///     Describes a scalar value streamed out of a <see cref="QueryModel" /> or <see cref="ResultOperatorBase" />. A scalar
    ///     value corresponds to a
    ///     value calculated from the result set, as produced by <see cref="CountResultOperator" /> or
    ///     <see cref="ContainsResultOperator" />, for instance.
    /// </summary>
    internal sealed class StreamedScalarValueInfo : StreamedValueInfo
    {
