...
namespace Core.Arango.Relinq.Clauses.StreamedData
{
    ...
    ///     .
    /// </summary>
    internal abstract class StreamedValueInfo : IStreamedDataInfo
    {
        ...
        /// <summary>
        ///     Gets the type of the data described by this <see cref="IStreamedDataInfo" /> instance. This is the type of the
        ///     streamed value, or
        ...
        public virtual IStreamedDataInfo AdjustDataType(Type dataType)
        {
            ...
            {
                var message = string.Format("'{0}' cannot be used as the new data type for a value of type '{1}'.",
                    dataType, DataType);
