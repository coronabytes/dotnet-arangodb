...
{
    /// <summary>
    ///     Performs a reverse <see cref="IExpressionNode.Resolve" /> operation, i.e. creates a <see cref="LambdaExpression" />
    ///     from a given resolved expression,
    ///     substituting all <see cref="QuerySourceReferenceExpression" /> objects by getting the referenced objects from the
    ...
    /// </example>
    internal sealed class ReverseResolvingExpressionVisitor : RelinqExpressionVisitor
    {
        ...
        ///     The item expression representing the items passed to the generated <see cref="LambdaExpression" /> via its input
        ///     parameter.
        /// </param>
        ...
        /// </param>
        /// <returns>
        ///     A <see cref="LambdaExpression" /> from the given resolved expression, substituting all
        ...
        ///     <see cref="LambdaExpression" /> has exactly one
        ...
        /// <summary>
        ///     Performs a reverse <see cref="IExpressionNode.Resolve" /> operation on a <see cref="LambdaExpression" />, i.e.
        ///     creates a new
        ...
        /// </summary>
        /// <param name="itemExpression">
        ///     The item expression representing the items passed to the generated <see cref="LambdaExpression" /> via its new
        ///     input parameter.
        /// </param>
        /// <param name="resolvedExpression">
        ///     The resolved <see cref="LambdaExpression" /> for which to generate a reverse resolved
        ///     <see cref="LambdaExpression" />.
        /// </param>
        /// <param name="parameterInsertionPosition">The position at which to insert the new parameter.</param>
        /// <returns>
        ///     A <see cref="LambdaExpression" /> similar to the given resolved expression, substituting all
        ///     <see cref="QuerySourceReferenceExpression" />
        ...
        /// </returns>
        public static LambdaExpression ReverseResolveLambda(Expression itemExpression,
            LambdaExpression resolvedExpression, int parameterInsertionPosition)
        {
            ArgumentUtility.CheckNotNull("itemExpression", itemExpression);
            ArgumentUtility.CheckNotNull("resolvedExpression", resolvedExpression);
        ...
        protected internal override Expression VisitQuerySourceReference(QuerySourceReferenceExpression expression)
        {
            ...
            {
                var accessorLambda =
                    AccessorFindingExpressionVisitor.FindAccessorLambda(expression, _itemExpression, _lambdaParameter);
