...
{
    /// <summary>
    ///     Represents a clause in a <see cref="QueryModel" />'s <see cref="QueryModel.BodyClauses" /> collection. Body clauses
    ///     take the items generated by
    ///     the <see cref="QueryModel.MainFromClause" />, filtering (<see cref="WhereClause" />), ordering (
    ///     <see cref="OrderByClause" />), augmenting
    ///     (<see cref="AdditionalFromClause" />), or otherwise processing them before they are passed to the
    ///     <see cref="QueryModel.SelectClause" />.
    /// </summary>
    internal interface IBodyClause : IClause
    {
        /// <summary>
