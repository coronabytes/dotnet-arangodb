...
namespace Core.Arango.Relinq.Clauses
{
    ...
    ///     </ode>
    /// </example>
    internal sealed class OrderByClause : IBodyClause
    {
        /// <summary>
        ...
        /// <summary>
        ///     Gets the <see cref="Ordering" /> instances that define how to sort the items coming from previous clauses. The
        ///     order of the
        ///     <see cref="Orderings" /> in the collection defines their priorities. For example, { LastName, FirstName } would
        ///     sort all items by
        ///     LastName, and only those items that have equal LastName values would be sorted by FirstName.
        /// </summary>
        public ObservableCollection<Ordering> Orderings { get; }
