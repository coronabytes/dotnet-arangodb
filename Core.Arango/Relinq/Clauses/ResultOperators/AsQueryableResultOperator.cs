...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class AsQueryableResultOperator : SequenceTypePreservingResultOperatorBase
    {
        ...
        /// <summary>
        ///     A marker interface that must be implemented by the <see cref="IQueryModelVisitor " /> if the visitor supports the
        ///     <see cref="AsQueryableResultOperator" />.
        /// </summary>
        /// <remarks>
