...
{
    /// <summary>
    ///     Represents a <see cref="ResultOperatorBase" /> that is executed on a sequence, returning a new sequence as its
    ///     result.
    /// </summary>
    internal abstract class SequenceFromSequenceResultOperatorBase : ResultOperatorBase
    {
