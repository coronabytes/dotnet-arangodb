...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </summary>
    /// <remarks>
    ///     "Last" query methods taking a predicate are represented as a combination of a <see cref="WhereClause" /> and a
    ///     <see cref="LastResultOperator" />.
    /// </remarks>
    /// <example>
    ...
    /// </code>
    /// </example>
    internal sealed class LastResultOperator : ChoiceResultOperatorBase
    {
        /// <summary>
