...
{
    /// <summary>
    ///     Represents grouping the items returned by a query according to some key retrieved by a <see cref="KeySelector" />,
    ///     applying by an
    ///     <see cref="ElementSelector" /> to the grouped items. This is a result operator, operating on the whole result set
    ///     of the query.
    /// </summary>
    /// <example>
    ///     In C#, the "group by" clause in the following sample corresponds to a <see cref="GroupResultOperator" />. "s" (a
    ///     reference to the query source
    ///     "s", see <see cref="QuerySourceReferenceExpression" />) is the <see cref="ElementSelector" /> expression,
    ///     "s.Country" is the
    ...
    /// </code>
    /// </example>
    internal sealed class GroupResultOperator : SequenceFromSequenceResultOperatorBase, IQuerySource
    {
        ...
        /// </summary>
        /// <param name="itemName">
        ///     A name associated with the <see cref="IGrouping{TKey,TElement}" /> items generated by the result
        ///     operator.
        /// </param>
        ...
        ///     passed to
        ///     <see
        ///         cref="Queryable.GroupBy{TSource,TKey,TElement}(System.Linq.IQueryable{TSource},System.Linq.Expressions.Expression{System.Func{TSource,TKey}},System.Linq.Expressions.Expression{System.Func{TSource,TElement}})" />
        ///     .
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the type of the items generated by this <see cref="GroupResultOperator" />. The item type is an
        ///     instantiation of
        ///     <see cref="IGrouping{TKey,TElement}" /> derived from the types of <see cref="KeySelector" /> and
        ///     <see cref="ElementSelector" />.
        /// </summary>
        public Type ItemType => typeof(IGrouping<,>).MakeGenericType(KeySelector.Type, ElementSelector.Type);
        ...
        public override IStreamedDataInfo GetOutputDataInfo(IStreamedDataInfo inputInfo)
        {
            ...
            return new StreamedSequenceInfo(typeof(IQueryable<>).MakeGenericType(ItemType),
