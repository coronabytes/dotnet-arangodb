...
{
    /// <summary>
    ///     Represents a <see cref="ValueFromSequenceResultOperatorBase" /> that is executed on a sequence, choosing a single
    ///     item for its result.
    /// </summary>
    internal abstract class ChoiceResultOperatorBase : ValueFromSequenceResultOperatorBase
    {
