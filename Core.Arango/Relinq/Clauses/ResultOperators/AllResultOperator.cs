...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class AllResultOperator : ValueFromSequenceResultOperatorBase
    {
        ...
        ///     The predicate to evaluate. This is a resolved version of the body of the <see cref="LambdaExpression" /> that would
        ///     be
        ...
        public override StreamedValue ExecuteInMemory<T>(StreamedSequence input)
        {
            ...
            var predicateLambda =
                ReverseResolvingExpressionVisitor.ReverseResolve(input.DataInfo.ItemExpression, Predicate);
