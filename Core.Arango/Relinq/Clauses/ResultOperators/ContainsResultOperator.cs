...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class ContainsResultOperator : ValueFromSequenceResultOperatorBase
    {
        ...
        /// <summary>
        ///     Gets the constant value of the <see cref="Item" /> property, assuming it is a <see cref="ConstantExpression" />. If
        ///     it is
