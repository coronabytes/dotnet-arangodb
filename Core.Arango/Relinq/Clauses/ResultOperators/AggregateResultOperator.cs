...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class AggregateResultOperator : ValueFromSequenceResultOperatorBase
    {
        ...
        public AggregateResultOperator(LambdaExpression func)
        {
            ...
            if (func.Type.GetTypeInfo().IsGenericTypeDefinition)
                throw new ArgumentException("Open generic delegates are not supported with AggregateResultOperator",
                    "func");
