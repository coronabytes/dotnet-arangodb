...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    ///     <see cref="DefaultIfEmptyResultOperator" />.
    ///     <code>
    /// var query = (from s in Students
    ///              select s).DefaultIfEmpty ("student");
    /// </code>
    /// </example>
    internal sealed class DefaultIfEmptyResultOperator : SequenceTypePreservingResultOperatorBase
    {
        ...
        /// <summary>
        ///     Gets the constant <see cref="object" /> value of the <see cref="OptionalDefaultValue" /> property, assuming it is a
        ///     <see cref="ConstantExpression" />. If it is
        ///     not, an <see cref="InvalidOperationException" /> is thrown. If it is <see langword="null" />,
