...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </summary>
    /// <remarks>
    ///     "First" query methods taking a predicate are represented as a combination of a <see cref="WhereClause" /> and a
    ///     <see cref="FirstResultOperator" />.
    /// </remarks>
    /// <example>
    ...
    /// </code>
    /// </example>
    internal sealed class FirstResultOperator : ChoiceResultOperatorBase
    {
        /// <summary>
