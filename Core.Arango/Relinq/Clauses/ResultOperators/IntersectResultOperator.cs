...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class IntersectResultOperator : SequenceTypePreservingResultOperatorBase
    {
        ...
        public override StreamedSequence ExecuteInMemory<T>(StreamedSequence input)
        {
            ...
            var result = sequence.Intersect(GetConstantSource2<T>());
        ...
        {
            return "Intersect(" + Source2.BuildString() + ")";
        }
    }
}