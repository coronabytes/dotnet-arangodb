...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    /// </code>
    /// </example>
    internal sealed class SkipResultOperator : SequenceTypePreservingResultOperatorBase
    {
        ...
        /// <summary>
        ///     Gets the constant <see cref="int" /> value of the <see cref="Count" /> property, assuming it is a
