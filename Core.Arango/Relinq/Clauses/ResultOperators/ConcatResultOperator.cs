...
namespace Core.Arango.Relinq.Clauses.ResultOperators
{
    ...
    ///     <see cref="UnionResultOperator" /> but
    ///     retaining duplicates (and order).
    ///     This is a result operator, operating on the whole result set of a query.
    /// </summary>
    /// <example>
    ///     In C#, the "Concat" call in the following example corresponds to a <see cref="ConcatResultOperator" />.
    ///     <code>
    /// var query = (from s in Students
    ///              select s).Concat(students2);
    /// </code>
    /// </example>
    internal sealed class ConcatResultOperator : SequenceFromSequenceResultOperatorBase, IQuerySource
    {
        ...
        /// <summary>
        ///     Gets the value of <see cref="Source2" />, assuming <see cref="Source2" /> holds a <see cref="ConstantExpression" />
        ///     . If it doesn't,
        ...
        {
            return new ConcatResultOperator(_itemName, _itemType, _source2);
        }
        ...
        public override IStreamedDataInfo GetOutputDataInfo(IStreamedDataInfo inputInfo)
        {
            ...
            return new StreamedSequenceInfo(typeof(IQueryable<>).MakeGenericType(_itemType),
                new QuerySourceReferenceExpression(this));
        }
