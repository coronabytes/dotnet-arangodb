...
namespace Core.Arango.Relinq.Clauses.Expressions
{
    ...
    ///     point back, to a clause defined prior to the clause holding a <see cref="QuerySourceReferenceExpression" />.
    ///     Otherwise, exceptions might be
    ///     thrown at runtime.
    /// </summary>
    /// <remarks>
    ///     This particular expression overrides <see cref="Equals" />, i.e. it can be compared to another
    ///     <see cref="QuerySourceReferenceExpression" /> based
    ///     on the <see cref="ReferencedQuerySource" />.
    /// </remarks>
    internal sealed class QuerySourceReferenceExpression : Expression
    {
#if NET_3_5
    public const ExpressionType ExpressionType = (ExpressionType) 100001;
        ...
        public IQuerySource ReferencedQuerySource { get; }

        /// <summary>
        ///     Determines whether the specified <see cref="T:System.Object" /> is equal to the current
        ///     <see cref="QuerySourceReferenceExpression" /> by
        ...
        ///     <see cref="QuerySourceReferenceExpression" /> that points to the
