...
namespace Core.Arango.Relinq
{
    ...
    /// <remarks>
    ///     <para>
    ///         When implement this interface, implement <see cref="VisitQueryModel" />, then call <c>Accept</c> on every
    ///         clause that should
    ...
    ///         via <see cref="IBodyClause.Accept" />, <see cref="JoinClause.Accept(IQueryModelVisitor, QueryModel, int)" />,
    ///         <see cref="Ordering.Accept" />,
    ///         <see cref="ResultOperatorBase.Accept" />, and so on.
    ///     </para>
    ///     <para>
    ///         <see cref="QueryModelVisitorBase" /> provides a robust default implementation of this interface that can be
    ///         used as a base for other visitors.
    ///     </para>
    /// </remarks>
    internal interface IQueryModelVisitor
    {
