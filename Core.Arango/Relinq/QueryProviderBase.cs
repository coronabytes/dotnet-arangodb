...
{
    /// <summary>
    ///     Provides a default implementation of <see cref="IQueryProvider" /> that executes queries (subclasses of
    ///     <see cref="QueryableBase{T}" />) by
    ///     first parsing them into a <see cref="QueryModel" /> and then passing that to a given implementation of
    ///     <see cref="IQueryExecutor" />.
    ///     Usually, <see cref="DefaultQueryProvider" /> should be used unless <see cref="CreateQuery{T}" /> must be manually
    ///     implemented.
    /// </summary>
    internal abstract class QueryProviderBase : IQueryProvider
    {
        ...
        ///     The <see cref="IQueryParser" /> used to parse queries. Specify an instance of
        ///     <see cref="Parsing.Structure.QueryParser" />
        ...
        /// <summary>
        ///     Gets or sets the implementation of <see cref="IQueryExecutor" /> used to execute queries created via
        ///     <see cref="CreateQuery{T}" />.
        /// </summary>
        /// <value>The executor used to execute queries.</value>
        public IQueryExecutor Executor { get; }

        [Obsolete("This property has been replaced by the QueryParser property. Use QueryParser instead. (1.13.92)",
            true)]
        ...
        /// <remarks>
        ///     This method is similar to the <see cref="IQueryProvider.Execute{TResult}" /> method, but without the cast to a
        ///     defined return type.
        /// </remarks>
        ...
        ///     <see cref="Queryable.Count{TSource}(System.Linq.IQueryable{TSource})" />, and it's also used by
        ///     <see cref="QueryableBase{T}" />
