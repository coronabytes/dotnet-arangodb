...
namespace Core.Arango.Relinq.Collections
{
    ...
    ///     <see cref="ObservableCollectionExtensions.AsChangeResistantEnumerableWithIndex{T}" />. This provides access
    ...
    internal struct IndexValuePair<T>
    {
        ...
        ///     <see cref="ObjectDisposedException" />. If an item is inserted into or removed from the collection before the
        ///     current item, this
        ///     index will change.
        /// </summary>
        public int Index => _enumerator.Index;
