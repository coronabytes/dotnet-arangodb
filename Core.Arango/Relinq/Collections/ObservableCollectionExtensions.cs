...
namespace Core.Arango.Relinq.Collections
{
    ...
    {
        /// <summary>
        ///     Returns an instance of <see cref="IEnumerable{T}" /> that represents this collection and can be enumerated even
        ...
        ///     Returns an instance of <see cref="IEnumerable{T}" /> that represents this collection and can be enumerated even
        ///     while the collection changes;
        ///     the enumerator will adapt to the changes (see <see cref="ChangeResistantObservableCollectionEnumerator{T}" />). The
        ///     enumerable will yield
        ///     instances of type <see cref="IndexValuePair{T}" />, which hold both the index and the value of the current item. If
