...
namespace Remotion.Utilities
{
    ...
    ///         <see cref="DebugAssert(bool)" /> and <see cref="TraceAssert(bool)" />).
    ///     </para>
    ///     <para>
    ...
    ///         not cause any side effects! See <see cref="ConditionalAttribute" /> or <see cref="Debug" /> and
    ...
    internal static class Assertion
    {
        ...
        [Conditional("DEBUG")]
        [AssertionMethod]
        public static void DebugAssert([AssertionCondition(AssertionConditionType.IS_TRUE)]
            bool assertion, string message)
        {
        ...
        public static void DebugAssert([AssertionCondition(AssertionConditionType.IS_TRUE)]
            bool assertion, string message, params object[] arguments)
        {
        ...
        [Conditional("TRACE")]
        [AssertionMethod]
        public static void TraceAssert([AssertionCondition(AssertionConditionType.IS_TRUE)]
            bool assertion, string message)
        {
            IsTrue(assertion, message);
        }
        ...
        [AssertionMethod]
        public static void IsTrue([AssertionCondition(AssertionConditionType.IS_TRUE)]
            bool assertion, string message)
        {
        ...
        [AssertionMethod]
        public static void IsFalse([AssertionCondition(AssertionConditionType.IS_FALSE)]
            bool expression, string message)
        {
        ...
        [StringFormatMethod("message")]
        public static void IsFalse([AssertionCondition(AssertionConditionType.IS_FALSE)]
            bool expression, string message, params object[] arguments)
        {
            if (expression)
                throw new InvalidOperationException(string.Format(message, arguments));
        }
        ...
        [AssertionMethod]
        public static T IsNotNull<T>([AssertionCondition(AssertionConditionType.IS_NOT_NULL)]
        ...
        [StringFormatMethod("message")]
        public static T IsNotNull<T>([AssertionCondition(AssertionConditionType.IS_NOT_NULL)]
            T obj, string message, params object[] arguments)
        {
        ...
        [AssertionMethod]
        public static void IsNull([AssertionCondition(AssertionConditionType.IS_NULL)]
        ...
        [StringFormatMethod("message")]
        public static void IsNull([AssertionCondition(AssertionConditionType.IS_NULL)]
            object obj, string message, params object[] arguments)
        {
            if (obj != null)
                throw new InvalidOperationException(string.Format(message, arguments));
        }
