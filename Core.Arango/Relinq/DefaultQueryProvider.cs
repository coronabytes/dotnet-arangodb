...
{
    /// <summary>
    ///     Represents a default implementation of <see cref="QueryProviderBase" /> that is automatically used by
    ///     <see cref="QueryableBase{T}" />
    ///     unless a custom <see cref="IQueryProvider" /> is specified. The <see cref="DefaultQueryProvider" /> executes
    ///     queries by parsing them into
    ///     an instance of type <see cref="QueryModel" />, which is then passed to an implementation of
    ///     <see cref="IQueryExecutor" /> to obtain the
    ///     result set.
    /// </summary>
    internal sealed class DefaultQueryProvider : QueryProviderBase
    {
        /// <summary>
        ///     Initializes a new instance of <see cref="DefaultQueryProvider" /> using a custom <see cref="IQueryParser" />.
        /// </summary>
        /// <param name="queryableType">
        ///     A type implementing <see cref="IQueryable{T}" />. This type is used to construct the chain of query operators. Must
        ///     be a generic type
        ///     definition.
        /// </param>
        /// <param name="queryParser">
        ///     The <see cref="IQueryParser" /> used to parse queries. Specify an instance of
        ///     <see cref="Parsing.Structure.QueryParser" /> for default behavior. See also
        ///     <see cref="QueryParser.CreateDefault" />.
        /// </param>
        ...
        public DefaultQueryProvider(Type queryableType, IQueryParser queryParser, IQueryExecutor executor)
            : base(ArgumentUtility.CheckNotNull("queryParser", queryParser),
