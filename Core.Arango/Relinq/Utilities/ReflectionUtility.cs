...
namespace Core.Arango.Relinq.Utilities
{
    ...
    {
        public static ReadOnlyCollection<MethodInfo> EnumerableAndQueryableMethods { get; } = new(typeof(Enumerable)
            .GetRuntimeMethods().Concat(typeof(Queryable).GetRuntimeMethods()).ToList());
