...
namespace Core.Arango.Relinq.Utilities
{
    ...
    /// </summary>
    internal static class ItemTypeReflectionUtility
    {
        /// <summary>
        ///     Tries to extract the item type from the input <see cref="Type" />.
        /// </summary>
        /// <param name="possibleEnumerableType">
        ///     The <see cref="Type" /> that might be an implementation of the <see cref="IEnumerable{T}" /> interface. Must not be
        ///     <see langword="null" />.
        /// </param>
        /// <param name="itemType">
        ///     An output parameter containing the extracted item <see cref="Type" /> or <see langword="null" />
        ///     .
        /// </param>
        /// <returns>
        ...
        public static bool TryGetItemTypeOfClosedGenericIEnumerable([NotNull] Type possibleEnumerableType,
            out Type itemType)
        {
