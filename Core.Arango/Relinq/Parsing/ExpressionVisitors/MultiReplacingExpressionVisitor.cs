...
{
    /// <summary>
    ///     Replaces <see cref="Expression" /> nodes according to a given mapping specification. Expressions are also replaced
    ...
    /// </summary>
    internal sealed class MultiReplacingExpressionVisitor : RelinqExpressionVisitor
    {
