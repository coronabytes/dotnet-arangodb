...
{
    /// <summary>
    ///     Provides a base class for transformers detecting <see cref="NewExpression" /> nodes for tuple types and adding
    ///     <see cref="MemberInfo" /> metadata
    ///     to those nodes. This allows LINQ providers to match member access and constructor arguments more easily.
    /// </summary>
    internal abstract class MemberAddingNewExpressionTransformerBase : IExpressionTransformer<NewExpression>
    {
...
// ReSharper restore ConditionIsAlwaysTrueOrFalse
        ...
        protected abstract MemberInfo[] GetMembers(ConstructorInfo constructorInfo,
