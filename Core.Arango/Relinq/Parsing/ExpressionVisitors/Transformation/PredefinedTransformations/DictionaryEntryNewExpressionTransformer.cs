...
{
    /// <summary>
    ///     Detects <see cref="NewExpression" /> nodes for <see cref="DictionaryEntry" /> and adds <see cref="MemberInfo" />
    ///     metadata to those nodes.
    ///     This allows LINQ providers to match member access and constructor arguments more easily.
    /// </summary>
    internal class DictionaryEntryNewExpressionTransformer : MemberAddingNewExpressionTransformerBase
    {
