...
namespace Core.Arango.Relinq.Parsing.ExpressionVisitors.Transformation.PredefinedTransformations
{
    ...
    /// </remarks>
    internal class InvocationOfLambdaExpressionTransformer : IExpressionTransformer<InvocationExpression>
    {
        ...
        public Expression Transform(InvocationExpression expression)
        {
            ...
            var invokedExpression = StripTrivialConversions(expression.Expression);
        ...
        private Expression InlineLambdaExpression(LambdaExpression lambdaExpression,
