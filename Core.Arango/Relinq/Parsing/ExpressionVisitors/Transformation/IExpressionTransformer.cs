...
{
    /// <summary>
    ///     <see cref="IExpressionTransformer{T}" /> is implemented by classes that transform <see cref="Expression" />
    ///     instances. The
    ///     <see cref="ExpressionTransformerRegistry" /> manages registration of <see cref="IExpressionTransformer{T}" />
    ///     instances, and the
    ...
    ///     </para>
    ///     <para>
    ///         <see cref="IExpressionTransformer{T}" /> can be used together with the
    ///         <see cref="TransformingExpressionVisitor" /> class by using the
    ///         <see cref="ExpressionTransformerRegistry" /> class as the transformation provider.
    ///         <see cref="ExpressionTransformerRegistry" /> converts
    ///         strongly typed <see cref="IExpressionTransformer{T}" /> instances to weakly typed
    ///         <see cref="ExpressionTransformation" /> delegate instances.
    ///     </para>
    /// </remarks>
    internal interface IExpressionTransformer<T> where T : Expression
    {
        /// <summary>
