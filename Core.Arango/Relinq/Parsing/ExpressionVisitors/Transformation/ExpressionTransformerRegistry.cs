...
namespace Core.Arango.Relinq.Parsing.ExpressionVisitors.Transformation
{
    ...
    ///     weakly typed <see cref="ExpressionTransformation" /> instances. Use this class together with
    ///     <see cref="TransformingExpressionVisitor" />
    ///     in order to apply the registered transformers to an <see cref="Expression" /> tree.
    /// </summary>
    internal class ExpressionTransformerRegistry : IExpressionTranformationProvider
    {
        private readonly List<ExpressionTransformation> _genericTransformations = new();
        ...
        public int RegisteredTransformerCount => _transformations.CountValues();
        ...
        /// <summary>
        ///     Creates an <see cref="ExpressionTransformerRegistry" /> with the default transformations provided by this library
        ///     already registered.
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <see cref="VBCompareStringExpressionTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="VBInformationIsNothingExpressionTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="InvocationOfLambdaExpressionTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="NullableValueTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="KeyValuePairNewExpressionTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="DictionaryEntryNewExpressionTransformer" />
        ///         </item>
        ///         <item>
        ///             <see cref="TupleNewExpressionTransformer" />
        ///         </item>
        ///     </list>
        /// </remarks>
        ...
        ///     <see cref="IExpressionTransformer{T}.SupportedExpressionTypes" />. If
        ///     <see cref="IExpressionTransformer{T}.SupportedExpressionTypes" />
        ...
        ///     expressions identified by <see cref="IExpressionTransformer{T}.SupportedExpressionTypes" />. For generic
        ///     transformers, <typeparamref name="T" />
        ///     must be <see cref="Expression" />.
        /// </typeparam>
        ...
        ///         <see cref="TransformingExpressionVisitor" />. When more than one transformer is registered for a certain
        ///         <see cref="ExpressionType" />,
        ///         each of them will get a chance to transform a given <see cref="Expression" />, until the first one returns a
        ///         new <see cref="Expression" />.
        ///         At that point, the transformation will start again with the new <see cref="Expression" /> (and, if the
        ...
        ///         <see cref="ExpressionType" /> values (including
        ...
        ///     </para>
        ///     <para>
        ///         When an <see cref="IExpressionTransformer{T}" /> is registered for an incompatible
        ///         <see cref="ExpressionType" />, this is not detected until
        ...
        private static Expression TransformExpression<T>(Expression expression, IExpressionTransformer<T> transformer)
            where T : Expression
        {
            T castExpression;
            try
