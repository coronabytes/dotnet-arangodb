...
{
    /// <summary>
    ///     Transforms a given <see cref="Expression" />. If the <see cref="ExpressionTransformation" /> can handle the
    ///     <see cref="Expression" />,
    ...
    internal delegate Expression ExpressionTransformation(Expression expression);
}