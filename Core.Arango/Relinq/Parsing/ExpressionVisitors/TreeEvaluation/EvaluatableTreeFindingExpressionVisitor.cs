...
namespace Core.Arango.Relinq.Parsing.ExpressionVisitors.TreeEvaluation
{
    ...
    ///     </para>
    ///     <para>
    ///         <see cref="MethodCallExpression" /> nodes that involve <see cref="IQueryable" /> parameters or object instances
    ...
    ///     </para>
    /// </remarks>
    internal sealed class EvaluatableTreeFindingExpressionVisitor : RelinqExpressionVisitor,
        IPartialEvaluationExceptionExpressionVisitor
    {
        ...
        private static readonly ExpressionType s_maxExpressionType =
            Enum.GetValues(typeof(ExpressionType)).Cast<ExpressionType>().Max();

        private readonly IEvaluatableExpressionFilter _evaluatableExpressionFilter;
        private readonly PartialEvaluationInfo _partialEvaluationInfo = new();
        ...
        public override Expression Visit(Expression expression)
        {
            ...
            var isParentNodeEvaluatable = _isCurrentSubtreeEvaluatable;
            ...
            _isCurrentSubtreeEvaluatable &=
                isParentNodeEvaluatable; // the _isCurrentSubtreeEvaluatable flag now relates to the parent node again
    ...
    protected override Expression VisitLambda (LambdaExpression expression)
        ...
        protected override Expression VisitMethodCall(MethodCallExpression expression)
        {
            ...
            for (var i = 0; i < expression.Arguments.Count && _isCurrentSubtreeEvaluatable; i++)
    ...
    protected override Expression VisitRelinqUnknownNonExtension (Expression expression)
    {
      ...
      return expression;
...
#if !NET_3_5
        /// <summary>
        ///     Determines whether the given <see cref="Expression" /> is one of the expressions defined by
        ///     <see cref="ExpressionType" /> for which
        ///     <see cref="ExpressionVisitor" /> has a dedicated Visit method. <see cref="ExpressionVisitor.Visit(Expression)" />
        ...
        ///     <see cref="ExpressionType" /> and
        ///     <see cref="ExpressionVisitor" /> has a dedicated Visit method for it; otherwise, <see langword="false" />.
        ///     Note that <see cref="ExpressionType.Extension" />-type expressions are considered 'not supported' and will also
