...
{
    /// <summary>
    ///     Applies <see cref="ExpressionTransformation" /> delegates obtained from an
    ///     <see cref="IExpressionTranformationProvider" /> to an expression tree.
    ///     The transformations occur in post-order (transforming child <see cref="Expression" /> nodes before parent nodes).
    ...
    /// </summary>
    internal sealed class TransformingExpressionVisitor : RelinqExpressionVisitor
    {
