...
namespace Core.Arango.Relinq.Parsing.ExpressionVisitors
{
    ...
    ///     <see cref="EvaluatableTreeFindingExpressionVisitor" />), i.e.
    ...
    ///     <see cref="EvaluatableTreeFindingExpressionVisitor" /> for analysis and once
    ///     again to replace nodes if possible (unless the parent node has already been replaced).
    /// </remarks>
    internal sealed class PartialEvaluatingExpressionVisitor : RelinqExpressionVisitor
    {
        /// <summary>
            ...
            IEvaluatableExpressionFilter evaluatableExpressionFilter)
        {
            ...
            var partialEvaluationInfo =
                EvaluatableTreeFindingExpressionVisitor.Analyze(expressionTree, evaluatableExpressionFilter);
        ...
        /// <summary>
        ///     Evaluates an evaluatable <see cref="Expression" /> subtree, i.e. an independent expression tree that is compilable
        ///     and executable
        ///     without any data being passed in. The result of the evaluation is returned as a <see cref="ConstantExpression" />;
        ///     if the subtree
        ...
        private Expression EvaluateSubtree(Expression subtree)
        {
            ...
            var lambdaWithoutParameters = Expression.Lambda<Func<object>>(Expression.Convert(subtree, typeof(object)));
