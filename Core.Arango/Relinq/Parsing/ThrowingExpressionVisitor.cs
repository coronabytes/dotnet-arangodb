...
{
    /// <summary>
    ///     Implements an <see cref="RelinqExpressionVisitor" /> that throws an exception for every expression type that is not
    ///     explicitly supported.
    ///     Inherit from this class to ensure that an exception is thrown when an expression is passed
    /// </summary>
    internal abstract class ThrowingExpressionVisitor : RelinqExpressionVisitor
    {
#if !NET_3_5
        ...
        protected virtual Expression VisitUnknownStandardExpression(Expression expression, string visitMethod,
        ...
        ///     invoke the
        ///     <paramref name="baseBehavior" /> of the <see cref="RelinqExpressionVisitor" /> class. The default behavior of this
        ///     method is to call the
        ///     <see cref="CreateUnhandledItemException{T}" /> method, but it can be overridden to do something else.
        /// </summary>
        /// <typeparam name="TItem">
        ///     The type of the item that could not be handled. Either an <see cref="Expression" /> type, a
        ///     <see cref="MemberBinding" />
        ///     type, or <see cref="ElementInit" />.
        /// </typeparam>
        ...
        ///     throw any exception.
        /// </returns>
        protected virtual TResult VisitUnhandledItem<TItem, TResult>(TItem unhandledItem, string visitMethod,
        ...
        protected override Expression VisitExtension(Expression expression)
        {
            ...
            return VisitUnhandledItem(expression, "VisitExtension", BaseVisitExtension);
        }
    ...
    protected Expression BaseVisitExtension (ExtensionExpression expression)
    {
      return base.VisitExtension (expression);
        ...
        {
            return VisitUnhandledItem(expression, "VisitUnary", BaseVisitUnary);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitBinary", BaseVisitBinary);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitTypeBinary", BaseVisitTypeBinary);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitConstant", BaseVisitConstant);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitConditional", BaseVisitConditional);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitParameter", BaseVisitParameter);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitLambda", BaseVisitLambda);
        }
    ...
    protected Expression BaseVisitLambda (LambdaExpression expression)
    {
      return base.VisitLambda (expression);
        ...
        {
            return VisitUnhandledItem(expression, "VisitMethodCall", BaseVisitMethodCall);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitInvocation", BaseVisitInvocation);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitMember", BaseVisitMember);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitNew", BaseVisitNew);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitNewArray", BaseVisitNewArray);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitMemberInit", BaseVisitMemberInit);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitListInit", BaseVisitListInit);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitBlock", BaseVisitBlock);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitDebugInfo", BaseVisitDebugInfo);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitDefault", BaseVisitDefault);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitGoto", BaseVisitGoto);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitIndex", BaseVisitIndex);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitLabel", BaseVisitLabel);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitLoop", BaseVisitLoop);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitRuntimeVariables", BaseVisitRuntimeVariables);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitSwitch", BaseVisitSwitch);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitTry", BaseVisitTry);
        }
        ...
        {
            return VisitUnhandledItem(elementInit, "VisitElementInit", BaseVisitElementInit);
        }
        ...
        {
            return VisitUnhandledItem(memberAssigment, "VisitMemberAssignment", BaseVisitMemberAssignment);
        }
        ...
        {
            return VisitUnhandledItem(binding, "VisitMemberMemberBinding", BaseVisitMemberMemberBinding);
        }
        ...
        {
            return VisitUnhandledItem(listBinding, "VisitMemberListBinding", BaseVisitMemberListBinding);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitCatchBlock", BaseVisitCatchBlock);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitLabelTarget", BaseVisitLabelTarget);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitSwitchCase", BaseVisitSwitchCase);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitSubQuery", BaseVisitSubQuery);
        }
        ...
        {
            return VisitUnhandledItem(expression, "VisitQuerySourceReference", BaseVisitQuerySourceReference);
        }
