...
namespace Core.Arango.Relinq.Parsing
{
    ...
    ///     <see cref="SubQueryExpression" /> and <see cref="QuerySourceReferenceExpression" />.
    /// </summary>
    internal abstract class RelinqExpressionVisitor : ExpressionVisitor
    {
        /// <summary>
        ...
        /// </returns>
        public static IEnumerable<Expression> AdjustArgumentsForNewExpression(IList<Expression> arguments,
        ...
        protected override Expression VisitNew(NewExpression expression)
        {
            ...
            var newArguments = VisitAndConvert(expression.Arguments, "VisitNew");
            if (newArguments != expression.Arguments)
            {
                ...
                return Expression.New(expression.Constructor,
                    AdjustArgumentsForNewExpression(newArguments, expression.Members), expression.Members);
            }
