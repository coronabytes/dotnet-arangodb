...
namespace Core.Arango.Relinq.Parsing.Structure.NodeTypeProviders
{
    ...
    ///     The <see cref="IsRegistered" /> and <see cref="GetNodeType" /> methods delegate to these inner instances. This is
    ///     an
    ///     implementation of the Composite Pattern.
    /// </summary>
    internal sealed class CompoundNodeTypeProvider : INodeTypeProvider
    {
        ...
        public IList<INodeTypeProvider> InnerProviders => _innerProviders;
