...
{
    /// <summary>
    ///     Implements <see cref="IExpressionTreeProcessor" /> by storing a list of inner
    ///     <see cref="IExpressionTreeProcessor" /> instances.
    ///     The <see cref="Process" /> method calls each inner instance in the order defined by the
    ///     <see cref="InnerProcessors" /> property. This is an
    ///     implementation of the Composite Pattern.
    /// </summary>
    internal sealed class CompoundExpressionTreeProcessor : IExpressionTreeProcessor
    {
        ...
        public IList<IExpressionTreeProcessor> InnerProcessors => _innerProcessors;
