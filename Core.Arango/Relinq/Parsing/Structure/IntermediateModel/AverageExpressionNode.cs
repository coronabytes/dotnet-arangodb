...
{
    /// <summary>
    ///     Represents a <see cref="MethodCallExpression" /> for the different overloads of
    ///     <see cref="Queryable.Average(IQueryable{int})" />.
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class AverageExpressionNode : ResultOperatorExpressionNodeBase
    {
