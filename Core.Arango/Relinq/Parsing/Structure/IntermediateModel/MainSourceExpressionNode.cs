...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     This node usually marks the end (i.e. the first node) of an <see cref="IExpressionNode" /> chain that represents a
    ///     query.
    /// </summary>
    internal sealed class MainSourceExpressionNode : IQuerySourceExpressionNode
    {
        ...
        public MainSourceExpressionNode(string associatedIdentifier, Expression expression)
        {
            ...
            if (!ItemTypeReflectionUtility.TryGetItemTypeOfClosedGenericIEnumerable(expression.Type,
