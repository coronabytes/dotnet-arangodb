...
{
    /// <summary>
    ///     Represents a <see cref="MethodCallExpression" /> for <see cref="Queryable.Max{TSource}" /> or
    ///     <see cref="Queryable.Max{TSource,TResult}" />.
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class MaxExpressionNode : ResultOperatorExpressionNodeBase
    {
