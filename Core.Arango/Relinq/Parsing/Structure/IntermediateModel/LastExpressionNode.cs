...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     <see cref="Queryable.Last{TSource}(System.Linq.IQueryable{TSource})" />,
    ///     <see
    ///         cref="Queryable.Last{TSource}(System.Linq.IQueryable{TSource},System.Linq.Expressions.Expression{System.Func{TSource,bool}})" />
    ///     ,
    ///     <see cref="Queryable.LastOrDefault{TSource}(System.Linq.IQueryable{TSource})" /> or
    ///     <see
    ///         cref="Queryable.LastOrDefault{TSource}(System.Linq.IQueryable{TSource},System.Linq.Expressions.Expression{System.Func{TSource,bool}})" />
    ///     .
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class LastExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        {
            return ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Last")
                .Concat(ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("LastOrDefault"));
        }
