...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class DistinctExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        {
            return ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Distinct")
