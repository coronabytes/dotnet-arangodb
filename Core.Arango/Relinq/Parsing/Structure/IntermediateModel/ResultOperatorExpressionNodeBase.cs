...
{
    /// <summary>
    ///     Acts as a base class for <see cref="IExpressionNode" />s standing for <see cref="MethodCallExpression" />s that
    ///     operate on the result of the query
    ///     rather than representing actual clauses, such as <see cref="CountExpressionNode" /> or
    ///     <see cref="DistinctExpressionNode" />.
    /// </summary>
    internal abstract class ResultOperatorExpressionNodeBase : MethodCallExpressionNodeBase
    {
        protected ResultOperatorExpressionNodeBase(
            MethodCallExpressionParseInfo parseInfo, LambdaExpression optionalPredicate,
