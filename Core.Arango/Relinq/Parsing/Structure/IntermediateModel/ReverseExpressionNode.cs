...
{
    /// <summary>
    ///     Represents a <see cref="MethodCallExpression" /> for <see cref="Queryable.Reverse{TSource}" />.
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class ReverseExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        {
            return ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Reverse");
        }
