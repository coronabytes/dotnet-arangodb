...
{
    /// <summary>
    ///     Contains metadata about a <see cref="MethodCallExpression" /> that is parsed into a
    ///     <see cref="MethodCallExpressionNodeBase" />.
    /// </summary>
    internal struct MethodCallExpressionParseInfo
    {
        public MethodCallExpressionParseInfo(string associatedIdentifier, IExpressionNode source,
