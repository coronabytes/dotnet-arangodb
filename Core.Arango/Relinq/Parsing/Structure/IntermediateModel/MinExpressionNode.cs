...
{
    /// <summary>
    ///     Represents a <see cref="MethodCallExpression" /> for <see cref="Queryable.Min{TSource}" /> or
    ///     <see cref="Queryable.Min{TSource,TResult}" />.
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class MinExpressionNode : ResultOperatorExpressionNodeBase
    {
