...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     <see
    ///         cref="Queryable.Union{TSource}(System.Linq.IQueryable{TSource},System.Collections.Generic.IEnumerable{TSource})" />
    ///     .
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class UnionExpressionNode : QuerySourceSetOperationExpressionNodeBase
    {
        ...
        {
            return new UnionResultOperator(AssociatedIdentifier, ItemType, Source2);
        }
    }
}