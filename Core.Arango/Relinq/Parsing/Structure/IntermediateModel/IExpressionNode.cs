...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    internal interface IExpressionNode
    {
        ...
        /// <summary>
        ///     Gets the identifier associated with this <see cref="IExpressionNode" />. <see cref="ExpressionTreeParser" /> tries
        ...
        ///     by the result of the projection of this <see cref="IExpressionNode" />. The result is an <see cref="Expression" />
        ///     that goes all the
        ///     way to an <see cref="QuerySourceReferenceExpression" />.
        /// </summary>
        /// <param name="inputParameter">
        ///     The parameter representing the input data streaming into an <see cref="IExpressionNode" />. This is replaced
        ///     by the projection data coming out of this <see cref="IExpressionNode" />.
        /// </param>
        ...
        ///     <see cref="IQuerySourceExpressionNode" /> (such as  <see cref="MainSourceExpressionNode" /> or
        ///     <see cref="SelectManyExpressionNode" />) must add
        ///     their clauses to the mapping in <see cref="Apply" /> if they want to be able to implement <see cref="Resolve" />
        ///     correctly.
        /// </param>
        /// <returns>
        ///     An equivalent of <paramref name="expressionToBeResolved" /> with each occurrence of
        ///     <paramref name="inputParameter" /> replaced by
        ///     the projection data streaming out of this <see cref="IExpressionNode" />.
        /// </returns>
        ...
        /// <summary>
        ///     Applies this <see cref="IExpressionNode" /> to the specified query model. Nodes can add or replace clauses, add or
        ///     replace expressions,
        ///     add or replace <see cref="ResultOperatorBase" /> objects, or even create a completely new <see cref="QueryModel" />
        ...
        ///     <see cref="MainSourceExpressionNode" /> or <see cref="SelectManyExpressionNode" />) must add their clauses to the
        ///     mapping in
        ///     <see cref="Apply" /> in order to be able to implement <see cref="Resolve" /> correctly.
        /// </param>
        /// <returns>
        ///     The modified <paramref name="queryModel" /> or a new <see cref="QueryModel" /> that reflects the changes made
        ///     by this node.
        /// </returns>
        /// <remarks>
        ///     For <see cref="MainSourceExpressionNode" /> objects, which mark the end of an <see cref="IExpressionNode" /> chain,
        ///     this method must not be called.
        ///     Instead, use <see cref="MainSourceExpressionNode.CreateMainFromClause" /> to generate a
        ///     <see cref="MainFromClause" /> and instantiate a new
