...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     <see cref="Queryable.Single{TSource}(System.Linq.IQueryable{TSource})" />,
    ///     <see
    ///         cref="Queryable.Single{TSource}(System.Linq.IQueryable{TSource},System.Linq.Expressions.Expression{System.Func{TSource,bool}})" />
    ///     ,
    ///     <see cref="Queryable.SingleOrDefault{TSource}(System.Linq.IQueryable{TSource})" /> or
    ///     <see
    ///         cref="Queryable.SingleOrDefault{TSource}(System.Linq.IQueryable{TSource},System.Linq.Expressions.Expression{System.Func{TSource,bool}})" />
    ///     .
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class SingleExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        {
            return new SingleResultOperator(ParsedExpression.Method.Name.EndsWith("OrDefault"));
        }
    }
}