...
namespace Core.Arango.Relinq.Parsing.Structure.IntermediateModel
{
    ...
    ///     <see cref="Queryable.Contains{TSource}(System.Linq.IQueryable{TSource},TSource)" /> and
    ...
    ///     represents a query.
    /// </summary>
    internal sealed class ContainsExpressionNode : ResultOperatorExpressionNodeBase
    {
        ...
        {
            return ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Contains")
        ...
        public static IEnumerable<NameBasedRegistrationInfo> GetSupportedMethodNames()
        {
            ...
            yield return new NameBasedRegistrationInfo(
                ...
                mi => mi.DeclaringType != typeof(string)
                      ...
                      && (mi.IsStatic && mi.GetParameters().Length == 2 ||
                          !mi.IsStatic && mi.GetParameters().Length == 1));
        }
