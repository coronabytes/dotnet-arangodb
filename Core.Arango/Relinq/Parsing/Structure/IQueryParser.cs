...
{
    /// <summary>
    ///     <see cref="IQueryParser" /> is implemented by classes taking an <see cref="Expression" /> tree and parsing it into
    ///     a <see cref="QueryModel" />.
    /// </summary>
    /// <remarks>
    ///     The default implementation of this interface is <see cref="QueryParser" />. LINQ providers can, however, implement
    ///     <see cref="IQueryParser" />
