...
{
    /// <summary>
    ///     Provides a common interface for classes mapping a <see cref="MethodInfo" /> to the respective
    ///     <see cref="IExpressionNode" />
    ///     type. Implementations are used by <see cref="ExpressionTreeParser" /> when a <see cref="MethodCallExpression" /> is
    ///     encountered to
    ...
    public interface INodeTypeProvider
    {
        ...
        /// <summary>
        ///     Gets the type of <see cref="IExpressionNode" /> that matches the given <paramref name="method" />, returning
        ///     <see langword="null" />
