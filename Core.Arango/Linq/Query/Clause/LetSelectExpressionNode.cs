...
{
    internal sealed class LetSelectExpressionNode : SelectExpressionNode, IQuerySourceExpressionNode
    {
        ...
        public bool IsLetNode => _letConstruction != null;
        ...
        public Expression GetResolvedAdaptedSelector(ClauseGenerationContext clauseGenerationContext)
        {
            ...
            return _resolvedAdaptedSelector.GetOrCreate(
                ...
                {
                    var letClause =
                        QuerySourceExpressionNodeUtility.GetQuerySourceForNode(this, clauseGenerationContext);
                    ...
                    return r.GetResolvedExpression(adaptedSelectorBody, Selector.Parameters[0],
        ...
        public Expression GetResolvedLetExpression(ClauseGenerationContext clauseGenerationContext)
        {
            ...
            return
                _resolvedLetExpression.GetOrCreate(
                    r => r.GetResolvedExpression(_letConstruction.Arguments[1], Selector.Parameters[0],
                        clauseGenerationContext));
        }
            ...
            ClauseGenerationContext clauseGenerationContext)
        {
            ...
            if (IsLetNode)
            {
                ...
                var letClause = new LetClause(_letConstruction.Constructor.GetParameters()[1].Name,
                    resolvedLetExpression);
