...
{
    internal class LetLambdaExpressionNode : MethodCallExpressionNodeBase, IQuerySourceExpressionNode
    {
            ...
            : base(parseInfo)
        {
            ...
            var itemType =
                ReflectionUtils.GetItemTypeOfClosedGenericIEnumerable(CollectionSelector.Body.Type,
                    "collectionSelector");
        ...
        public LambdaExpression LetSelector { get; }
        ...
        public Expression GetResolvedCollectionSelector(ClauseGenerationContext clauseGenerationContext)
        {
            return _cachedCollectionSelector.GetOrCreate(
                r => r.GetResolvedExpression(CollectionSelector.Body, CollectionSelector.Parameters[0],
            ...
            ClauseGenerationContext clauseGenerationContext)
        {
            ...
            var clause = new LetClause(CollectionSelector.Parameters[1].Name, resolvedLetSelector,
